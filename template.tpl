...

{
  ...
  "description": "Le Global Tag TimeOne vous permet de bénéficier de l'ensemble des technologies de tracking et d'encapsulation pour vos campagnes.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  {
    "type": "TEXT",
    "help": "Indiquez ici la liste de vos identifiants de produits contenu dans la panier de l'internaute séparés par des points-virgules.",
    "name": "cartProductsID",
